    ...
    const shapeDimensions = await inquirer.prompt([
        {
            type: "number",
            name: "width",
            message: chalk.cyanBright.italic.bold(` What is the width of the ${shape}? `),
        },
        {
            type: "number",
            name: "height",
            message: chalk.cyanBright.italic.bold(` What is the height of the ${shape}? `),
        },
    ]);
    ...
    const employeeSalary = await inquirer.prompt([
        {
            type: "number",
            name: "salary",
            message: chalk.cyanBright.italic.bold(` What is the salary of the ${employee}? `),
        },
    ]);
