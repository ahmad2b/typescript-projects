...
import { coursesData, instructorsData, studentsData } from "./Data.js";
...
export async function enterInstructorDash() {
    ...
    let user = instructorsData.find(
        (instructor) => instructor._username === enterDash.username && instructor._password === enterDash.password
    );
